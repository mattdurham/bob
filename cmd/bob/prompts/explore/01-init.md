...
## Your Goal
Initialize the exploration workflow - verify git repository and prepare to gather exploration goals.
...
- ❌ Do not ask the user what they want to explore - that happens in the PROMPT step
- ❌ Do not start exploring the codebase

## When You're Done
Once you've verified the git repository:

1. Inform the user: "Ready to begin exploration workflow"
