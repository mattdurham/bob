...
Task(subagent_type: "Explore",
     ...
     prompt: "Read all .bob/state/audit-module-*.md files and consolidate into a single report.
              ...
              **Impact:** [what could go wrong because of this]
              ...
              [List behaviors found in code but not captured in CLAUDE.md — candidates for new invariants]
...
- This workflow is **read-only** — it never modifies code or CLAUDE.md files
