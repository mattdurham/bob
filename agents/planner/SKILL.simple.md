...
- **CLAUDE.md updates** (for documented modules)

**Guidelines:**
- Each step should be specific and actionable
- Order matters (dependencies first)
- Keep steps focused (one clear goal per step)
- **Pair code changes with doc updates** — never plan a code change to a documented module without checking whether any invariant in `CLAUDE.md` needs updating
...
[If any documented modules are in scope, list the required CLAUDE.md checks here:]

### Module: `path/to/module/`

**Has:** CLAUDE.md with numbered invariants

**Required updates:**
- [ ] Review CLAUDE.md invariants against all code changes
- [ ] Update CLAUDE.md if any invariant is affected or no longer accurate
...
- [ ] CLAUDE.md updated for any affected invariants (if applicable)
