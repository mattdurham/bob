...
Agent(subagent_type: "Explore",
     ...
     prompt: "Read .bob/state/discovery.md for context on what was found.
             ...
             For any spec-driven modules identified in discovery, read SPECS.md
             FIRST to understand the documented contracts before reading code.
...
Agent(subagent_type: "Explore",
     ...
     prompt: "Read .bob/state/discovery.md for context on what was found.
             ...
             For any spec-driven modules, read NOTES.md for documented
